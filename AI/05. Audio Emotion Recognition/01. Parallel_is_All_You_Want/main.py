...
from model import parallel_all_you_want, three_attention_model, three_cnn_model, lstm_model, my_model
...
model = my_model(num_emotions=len(emotions_dict)).to(device) 
